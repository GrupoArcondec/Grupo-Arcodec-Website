...
(function () {
    ...
    var I18N = {
        es: {
            ...
            sec1Card3: 'Instalaciones normadas',
            catIE: 'Ingeniería Eléctrica',
            catIE2: 'Ingeniería Eléctrica',
            catIE3: 'Ingeniería Eléctrica',

            sec2Title: 'Implementación de centro de datos',
            sec2Card1: 'Comunicación eficiente',
            sec2Card2: 'Infraestructura que conecta',
            sec2Card3: 'Infraestructura crítica que respalda tu operación 24/7',
            catDC: 'Data Center',
            catDC2: 'Data Center',
            catDC3: 'Data Center',
            ...
            listIETitle: 'Ingeniería Eléctrica',
            ie1: 'Proyectos eléctricos',
            ie2: 'Corriente alterna (AC) y directa (DC)',
            ie3: 'Estudios eléctricos',
            ie4: 'Servicios eléctricos',
            ie5: 'Diseño de red de tierras',
            ie6: 'Sistemas fotovoltaicos',
            ie7: 'Mantenimiento eléctrico preventivo y correctivo',

            listDCTitle: 'Data Centers',
            dc1: 'Sistema de respaldo UPS (Power System)',
            dc2: 'Instalación de tablero de distribución en corriente directa tipo BDCBB',
            dc3: 'Generadores de emergencia',
            dc4: 'Plantas de Corriente Directa',
            dc5: 'Inversores y banco de baterías',
            dc6: 'Sistema de tierras física y pararrayos',

            contactTitle: 'Contáctanos',
            contactOffice: 'Oficina Monterrey',
            contactCall: 'Llama ahora',
            contactMobile: 'Celular (55) 3032 6595',
            contactMail: 'Correos',
            contactSalesMail: 'ventas@arcondec.mx',
        ...
        en: {
            ...
            sec1Card2: 'Safe and efficient power',
            sec1Card3: 'Code-compliant installations',
            catIE: 'Electrical Engineering',
            catIE2: 'Electrical Engineering',
            catIE3: 'Electrical Engineering',

            sec2Title: 'Data Center Implementation',
            sec2Card1: 'Efficient communication',
            sec2Card2: 'Infrastructure that connects',
            sec2Card3: 'Critical infrastructure that supports your 24/7 operation',
            catDC: 'Data Center',
            catDC2: 'Data Center',
            catDC3: 'Data Center',
            ...
            listIETitle: 'Electrical Engineering',
            ie1: 'Electrical Projects',
            ie2: 'Alternating Current (AC) and Direct Current (DC)',
            ie3: 'Electrical Studies',
            ie4: 'Electrical Services',
            ie5: 'Grounding Network Design',
            ie6: 'Photovoltaic Systems',
            ie7: 'Preventive and Corrective Electrical Maintenance',

            listDCTitle: 'Data Centers',
            dc1: 'UPS Backup System (Power System)',
            dc2: 'Direct Current Distribution Board Installation (BDCBB type)',
            dc3: 'Emergency Generators',
            dc4: 'Direct Current Plants',
            dc5: 'Inverters and Battery Banks',
            dc6: 'Grounding and Lightning Protection System',

            contactTitle: 'Contact Us',
            contactOffice: 'Monterrey Office',
            contactCall: 'Call Now',
            contactMobile: 'Mobile: (55) 3032 6595',
            contactMail: 'Send Us a Message',
            contactSalesMail: 'sales@arcondec.mx',
